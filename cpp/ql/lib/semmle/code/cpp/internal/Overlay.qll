...
overlay[local]
predicate locally_reachable_trap_or_tag(boolean is_overlay, string source_file, @trap_or_tag t) {
...
overlay[local]
predicate locally_in_trap_or_tag(boolean is_overlay, @element e, @trap_or_tag t) {
  (if isOverlay() then is_overlay = true else is_overlay = false) and
  in_trap_or_tag(e, t)
}

overlay[discard_entity]
predicate discard_element(@element e) {
