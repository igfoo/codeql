...
class NumberType extends RefType {
  NumberType() { exists(TypeNumber number | hasAncestor(number, this)) }
}
...
class ThrowableType extends RefType {
  ThrowableType() { exists(TypeThrowable throwable | hasAncestor(throwable, this)) }
}
...
class UncheckedThrowableType extends RefType {
  UncheckedThrowableType() {
    exists(TypeError e | hasAncestor(e, this)) or
    exists(TypeRuntimeException e | hasAncestor(e, this))
  }
}
